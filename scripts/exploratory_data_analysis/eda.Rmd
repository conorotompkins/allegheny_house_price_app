...
House sales plateaued after the 2008 mortgage crisis, but accelerated in the mid-2010s.
```{r}
...
The location of the house (`geo_id`) has a big impact on `sale_price_adj` (interactive map).
```{r}
