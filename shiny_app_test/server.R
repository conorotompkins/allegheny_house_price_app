...
model_fit <- read_rds("shiny_app/bag_model_fit_v.03.rds")
...
full_model_results <- vroom("shiny_app/trimmed_full_model_results.csv")

geo_id_shapes <- st_read("shiny_app/unified_geo_ids/unified_geo_ids.shp")
